<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="index.php"><i class="fas fa-fw fa-tachometer-alt"></i>สำนักงานสภาเกษตรกรแห่งชาติ</a>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link" href="user_regis.php">
            <i class="fas fa-fw fa-cog"></i>
            <span>ข้อมูลทะเบียนสมาชิก</span>
        </a>
    </li> 
    ...
    <!-- <li class="nav-item">
        ...
        <div id="collapseMN" class="collapse" aria-labelledby="headingMN" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="Cus_credit.php">3.แหล่งเงินทุนสนับสนุน</a> 
            </div>
        </div>
    </li> -->
